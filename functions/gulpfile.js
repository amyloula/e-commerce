...
gulp.task('jshint', function() {
  return gulp.src(['/scripts/**/*.js', 'public/styleguide/**/*.js'])
...
gulp.task('copy-workerscripts', function() {
  return gulp.src('public/scripts/jsqrcode/*.js')
...
gulp.task('scripts', function() {
  var sources = [
    ...
    'public/scripts/*.js',
    'public/styleguide/wskComponentHandler.js',
...
gulp.task('serve', ['styles'], function() {
  ...
  gulp.watch(['public/**/**/**/*.{scss,css}'], ['styles', reload]);
  gulp.watch(['public/scripts/**/*.js','public/styleguide/**/*.js'], ['jshint']);
